...
if __name__ == '__main__':
    ...
    _, _, dist, H = load_IceSat2(fullfn, 'gt1l')

    fig, ax = plt.subplots(1, 1, figsize=(10, 4))

    draw_fig(ax, dist, H, title='all points')
    plt.tight_layout()
    plt.savefig('raw_rs_nc.png', dpi=300)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig('test_rs_nc.png', dpi=300)
    plt.show()
